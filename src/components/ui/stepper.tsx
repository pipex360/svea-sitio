...
/**
 * Stepper de 21st.dev, copiado sin cambios.
 *
 * Sus dos dependencias ya estaban en el proyecto: lucide-react la trae el
 * menú y @radix-ui/react-icons el chevron del mismo menú. No se instaló nada.
 *
 * Aquí se usa en modo presentación —`asChild` en el disparador, que lo
 * convierte en un <div> sin botón— porque los cinco pasos son un proceso que
 * se lee, no un formulario que se recorre. Por eso tampoco lleva directiva de
 * cliente: Astro lo dibuja en el servidor y no viaja JavaScript.
 */
